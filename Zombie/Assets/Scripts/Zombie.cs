...
public class Zombie : LivingEntity
{
    ...
    private IEnumerator UpdatePath()
    {
        ...
        while (!dead)
        {
            ...
            else
            {
                ...
                {
                    if (collider.TryGetComponent<LivingEntity>(out LivingEntity livingEntity)
                        && !livingEntity.dead)
                    {
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.TryGetComponent<LivingEntity>(out LivingEntity livingEntity)
            && targetEntity.Equals(livingEntity))
        {
